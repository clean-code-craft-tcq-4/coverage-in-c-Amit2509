...
- Enter Reflections: Replace the `_e nter` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
**Reducing the Cyclomatic Complexity is what I would plan to take care of most in the next coming four weeks as I had never paid attention on this factor in my code ever**
